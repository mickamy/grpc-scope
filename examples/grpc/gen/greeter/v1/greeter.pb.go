...
const file_greeter_v1_greeter_proto_rawDesc = "" +
	...
	"\bSayHello\x12\x1b.greeter.v1.SayHelloRequest\x1a\x1c.greeter.v1.SayHelloResponseB\xad\x01\n" +
	"\x0ecom.greeter.v1B\fGreeterProtoP\x01ZDgithub.com/mickamy/grpc-scope/examples/grpc/gen/greeter/v1;greeterv1\xa2\x02\x03GXX\xaa\x02\n" +
	"Greeter.V1\xca\x02\n" +
